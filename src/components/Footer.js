...
const Footer = () => {
    return (
        <footer className="footer items-center p-4 bg-indigo-400">
            <aside className="items-center grid-flow-col">
                ...
                <p>Designed & Implemented by Soumya Prakash Nayak</p>
            </aside>
            <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                <a href="https://www.instagram.com/n_soumya_prakash/" target='__blank'><Image width={30} height={30} src="/instagram-logo.png" alt="instagram" /></a>
                <a href="https://github.com/SoumyaRKN" target='__blank'><Image width={30} height={30} src="/github-logo.png" alt="github" /></a>
                <a href="https://linkedin.com/in/soumya-prakash-nayak-558151261" target='__blank'><Image width={30} height={30} src="/linkedin-logo.png" alt="linkedin" /></a>
            </nav>
        </footer>
    );
}
